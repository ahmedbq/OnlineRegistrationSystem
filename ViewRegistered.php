<?php
session_start();
require_once 'ViewRegistered.php';
...
<html>
    ...
    <head>
        <title>View Registered Classes</title>
        <meta charset="utf-8" />
...
mysqli_select_db($conn, "BAEdb") or die("no db found");
  ...
  $sql = "SELECT Section.CRN, Course.Course_ID, Course_Name,Course.Credits ,Section.Section_ID, Building_Number, Room_Number,Section.Semester,Section.Year,Days, Section.Period, start_time, end_time
...
AND Section.Timeslot_ID = Period.Timeslot_ID ";
    ...
    $sql.= " AND Section.Year = '2018' AND (Section.Semester = 'Spring' OR Section.Semester = 'Winter')";
